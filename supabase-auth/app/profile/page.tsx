...
function SectionLabel({
	...
	return (
		<h2
			className={`text-xs font-medium uppercase tracking-wider text-zinc-400 dark:text-zinc-500 ${className ?? ""}`}
		>
			{children}
		</h2>
	);
	...
	return (
		<main className="flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-black">
			<div className="w-full max-w-sm px-4 py-12">
					...
					{hasEmailIdentity ? (
						...
						<div className="space-y-3">
							<p className="text-sm text-zinc-500 dark:text-zinc-400">
								Your account uses Google sign-in. You can set a
				...
				{/* Danger zone */}
				<Section>
					<SectionLabel className="text-red-500 dark:text-red-500">
						Danger zone
					</SectionLabel>
					<AccountDeleteButton />
				</Section>
